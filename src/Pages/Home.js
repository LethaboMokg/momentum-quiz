...
This is a fun and easy quiz to ascertain how financially savvy you are. People with a score higher than 7 might get a great prize from us.</p>
      ...
      <br/>
      <br/>
      <button className='start' id='submit' onClick={() => {setGoToQuiz(true);}} type='button'>Let's get started</button>
      <br/>
      <br/>
    </div>
  );
